return {
  ...
  ui_scaling_tooltip = {
    ...
    en = "Automaticamente redimensionar la interfaz cuando la resolución exceda 1080p.",
  ...
  toggle_developer_console = {
    ...
    es = "Abrir Consola de Desarrollo",
  ...
  show_network_debug_info_tooltip = {
    ...
    es = "Registra todas las llamadas de red y datos transferidos a través de VMF.\n\n" ..
         "Esta información se registra a nivel 'info'.",
  ...
  log_ui_renderers_info = {
    ...
    es = "Registra Información de la Renderización de la Interfaz",
  ...
  log_ui_renderers_info_tooltip = {
    en = "Log the UI Renderer's creator name and all the materials passed as the arguments.\n\n" ..
         "The method 'info' is used for the logging.",
    es = "Registra el nombre del creador de la interfaz y de todos los materiales recibidos como argumentos\n\n" ..
         "Esta información se registra a nivel 'info'.",
  ...
  chat_history_remove_dups_mode_tooltip = {
    ...
    es = "Que entradas duplicadas deberian ser borradas.\n\n" ..
         "-- ÚLTIMA --\nBorra las ",
  ...
  mutators_banner_tooltip = {
    ...
    es = "Activar y desactivar mutaciones",
  },
  no_mutators = {
  ...
  no_mutators_tooltip = {
    ...
    es = "Suscríbete a mods y mutaciones en el workshop",
  },
